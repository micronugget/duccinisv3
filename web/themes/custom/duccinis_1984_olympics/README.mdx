...
duccinis_1984_olympics theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of duccinis_1984_olympics theme and run the following commands:
`nvm use`
...
`drush en duccinis_1984_olympics -y`
`drush config-set system.theme default duccinis_1984_olympics -y`
