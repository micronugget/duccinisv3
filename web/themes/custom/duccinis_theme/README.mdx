...
duccinis_theme theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of duccinis_theme theme and run the following commands:
`nvm use`
...
`drush en duccinis_theme -y`
`drush config-set system.theme default duccinis_theme -y`
